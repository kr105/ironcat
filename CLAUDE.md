...
- Never use a period at the end of a comment
...
- No silent returns on error paths, every error path must log before propagating
...
- Every #[allow(clippy::...)] must have a comment explaining why the lint doesn't apply. No blanket allows on functions; put them on the specific line
